...
class Downloader:
    ...
    def download_video(self, url: str, audio_only: bool):
        try:
            ...
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                filepath = self._get_filepath(info, audio_only)
    ...
    def _get_ydl_opts(self, audio_only: bool = False):
        if audio_only:
            ydl_opts = {
    ...
    def _get_filepath(self, info: dict, audio_only: bool) -> Path:
